  ...
  return {
    ...
    defaults: {
      ...
      features: {
        ...
        caseSensitiveRedirects: false // MOD enable case sensitivity in redirection
      },
    ...
    validate: function () {
      ...
      var regex_fields = [ 'endRedaction', 'hiddenPage', 'privateComment', 'privateSection', 'earliestDate' ]
      for (var i = 0; i < regex_fields.length; i++){
        ...
        if (regex_value){
          ...
          if (i > 2 && !config.redaction.endRedaction){
