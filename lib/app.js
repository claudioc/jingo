...
module.exports.initialize = function (config) {
  ...
  app.use(function (req, res, next) {
    res.locals = {
      ...
      get mainColumn () {
        return config.get('layout').mainColumn.toString()
      },
      get footerColumn () {
        return config.get('layout').footerColumn.toString()
      },
      get footerSidebarColumn () {
        return (12 - config.get('layout').footerColumn).toString()
      },
      get sidebarMobile () {
