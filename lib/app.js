...
module.exports.initialize = function (config) {
  ...
  var mountPath = app.locals.config.getMountPath();
  app.use(mountPath, require("../routes/wiki"))
     .use(mountPath, require("../routes/pages"))
     .use(mountPath, require("../routes/search"))
     .use(mountPath, require("../routes/auth"))
     .use(mountPath, require("../routes/misc"));
