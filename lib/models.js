...
function Page(name, UrlPrefix, revision) {
  name = name || "";
  this.setNames(name);
...
Page.prototype.urlFor = function(action) {
  ...
  switch(true) {
    ...
    case action == 'show':
      return this.UrlPrefix + "/wiki/" + wname;

    case action == 'edit':
      return this.UrlPrefix + "/pages/" + wname + "/edit";

    case action == 'edit error':
      return this.UrlPrefix + "/pages/" + wname + "/edit?e=1";

    case action == 'edit put':
      return this.UrlPrefix + "/pages/" + wname;

    case action == 'history':
      return this.UrlPrefix + "/wiki/" + wname + "/history";

    case action == 'compare':
      return this.UrlPrefix + "/wiki/" + wname + "/compare";

    case action == 'new':
      return this.UrlPrefix + "/pages/new/" + wname;

    case action == 'new error':
      return this.UrlPrefix + "/pages/new/" + wname + "?e=1";
  }
